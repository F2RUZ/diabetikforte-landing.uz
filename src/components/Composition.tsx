  ...
  return (
    <section className="w-full py-6 bg-white overflow-hidden" id="composition">
      <div className="max-w-[1100px] mx-auto px-4">
        {/* Sarlavha - Ixcham va to'q qizil tonda */}
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          <div className="w-full lg:w-[360px] bg-white rounded-[35px] p-8 md:p-9 shadow-2xl shadow-red-900/5 border border-red-50 relative z-10 transition-all duration-500 hover:-translate-y-2 group">
            <div className="mb-6">
              <h3 className="text-[#8B0000] text-xl font-black uppercase italic group-hover:tracking-wider transition-all">
                ASOSIY
              </h3>
          ...
          <div className="flex flex-col items-center gap-8 z-20">
            <div className="w-48 h-48 md:w-64 md:h-64 relative group">
              {/* Orqa fondagi aylanuvchi nur (Qizil tonda) */}
              <div className="absolute inset-0 bg-gradient-to-tr from-[#8B0000]/10 to-transparent rounded-full animate-spin-slow" />

              <div className="absolute inset-3 bg-white rounded-full shadow-2xl flex items-center justify-center p-4 border-[8px] border-red-50 relative overflow-hidden">
                <Image
                  src="/product-center.png" // Bu yerda mahsulot qutisi bo'ladi
            ...
            {/* Quick Stats Grid - Ixcham shriftlar */}
            <div className="grid grid-cols-2 gap-3 w-full max-w-[380px]">
              {formulaData.map((m, idx) => (
                <div
                  key={idx}
                  className="bg-white p-4 rounded-[20px] border border-red-50 shadow-sm text-center hover:shadow-md transition-shadow"
                >
          ...
          <div className="w-full lg:w-[360px] bg-[#1A1A1A] rounded-[35px] p-8 md:p-9 shadow-2xl shadow-red-900/20 relative z-10 transition-all duration-500 hover:-translate-y-2 group">
            <div className="mb-6">
              ...
              <p className="text-[9px] text-white/40 font-bold uppercase tracking-widest mt-1 leading-tight">
                100% TABIIY VA XAVFSIZ KOMPONENTLAR TO'PLAMI
              </p>
